...
const TicketForm: React.FC<TicketFormProps> = ({ 
  ...
  useEffect(() => {
    ...
    loadReferenceData();
  }, [fetchSites, fetchSiteOwners, fetchCompanies, fetchCompanyContacts]);

  const priorities = ['Low', 'Medium', 'High', 'Critical'];

  const [formData, setFormData] = useState<Partial<Ticket>>({
    site: initialData.site || '',
    siteOwner: initialData.siteOwner || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const completeFormData: Omit<Ticket, 'id' | 'createdAt' | 'updatedAt'> = {
        ...
        type: formData.type as TicketType || 'job',
        ...
        <Card>
          ...
          <Card.Content>
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                <label htmlFor="type" className="label">Ticket Type</label>
                <select
                  id="type"
                  name="type"
                  value={formData.type}
              ...
              <div>
                <label htmlFor="siteOwner" className="label">Site Owner</label>
                <select
                  id="siteOwner"
                  name="siteOwner"
