...
const TicketCard: React.FC<TicketCardProps> = ({ ticket }) => {
  ...
  return (
    <Card className="cursor-pointer transition-all hover:border-primary dark:hover:border-primary-light h-full flex flex-col">
      <Link to={detailsUrl} className="flex flex-col h-full w-full">
        ...
        <Card.Footer className="flex items-center justify-between text-xs text-gray-400 mt-auto">
