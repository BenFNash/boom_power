/*
  ...
  1. New Tables
    - `job_templates` - Templates for recurring job tickets
    - `job_schedules` - Schedule definitions for recurring jobs
    - `scheduled_job_instances` - Track generated job instances

  2. Features
    - Create reusable job templates
    - Define recurring schedules (monthly, quarterly, etc.)
    - Automatic ticket generation before deadlines
    - Track generated instances to avoid duplicates
